...
|---|---|---|---|---|
| UTXO | 高い(独立出力を並列検証) | 持ちにくい(残高は集計、変数を持てない) | 高め(アドレス使い捨て) | Bitcoin、Litecoin、Cardano(EUTXO) |
| アカウント | 低い(同口座は直列化) | 持ちやすい(残高 + ストレージ) | 低め(残高が紐づく) | Ethereum、多くの L1 |
| EUTXO(拡張) | 高い | 持てる(出力にデータ + 検証子) | 高め | Cardano |
