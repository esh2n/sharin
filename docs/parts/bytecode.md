...
|---|---|---|---|---|
| ツリーウォーク | 遅い | 最も素直 | 速い(コンパイル不要) | lang 編、素朴な言語、設定 DSL |
| バイトコード VM(本章) | 中くらい | 素直 | 中(コンパイルが要る) | CPython、Ruby(YARV)、Lua、初期 JS |
| バイトコード + JIT | 速い | 複雑 | 遅い(ウォームアップ) | JVM HotSpot、V8、PyPy、.NET |
| AOT ネイティブ | 最速 | 複雑 | 最速(実行のみ) | Go、Rust、C/C++ |
