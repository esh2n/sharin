...
対策は、公開鍵が本当にその相手のものだと確かめること、つまり認証だ。相手の公開鍵に署名を付けて本人性を保証する。これが証明書であり、後の [TLS ハンドシェイク](/parts/tls-handshake)の章で、証明書で相手を認証してから DH を行う形を作る。鍵交換と認証は別の問題で、両方揃って初めて安全になる。
