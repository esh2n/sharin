...
ここまでの章は、ある前提の上に成り立っていた。どの Pod も同じで、区別がつかず、どれを消してもよい。だから[調整ループ](/parts/reconcile)は「3個であれ」とだけ言えばよかったし、[ローリング更新](/parts/rollout)はどれから入れ替えても構わなかったし、[Cluster Autoscaler](/parts/cluster-autoscaler)は好きな Pod を別のノードへ移せた。
